...
<div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'PingFang SC', sans-serif; line-height: 1.8; color: #333;">
    <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 24px; margin-bottom: 24px; border-radius: 8px;">
        <h2 style="color: white; margin-bottom: 12px; font-size: 24px;">💼 AI Red-Teamer — Adversarial AI Testing (Advanced); English & Chinese</h2>
    ...
    <div style="background: #e3f2fd; border-left: 4px solid #2196f3; padding: 16px; margin-bottom: 24px; border-radius: 4px;">
        <p style="margin: 0; color: #1565c0; font-size: 16px;"><strong>🔥 本月已招聘29人</strong></p>
    </div>
    ...
    <div style="background: #fff3e0; border-left: 4px solid #ff9800; padding: 16px; margin-bottom: 24px; border-radius: 4px;">
        ...
        <p style="margin: 0 0 8px 0; color: #666;">🌍 地区限制：美国、台湾、马来西亚（其他国家可个案考虑）</p>
        <p style="margin: 0; color: #666;">🗣️ 语言要求：英语和中文（普通话）母语级流利度</p>
    </div>
    ...
    <div style="background: #e8f5e9; border-radius: 8px; padding: 20px; margin-bottom: 24px;">
        ...
        <div style="background: white; border-radius: 6px; padding: 12px; margin-top: 12px;">
            <a href="https://t.mercor.com/srNUC" target="_blank" style="color: #667eea; text-decoration: none; word-break: break-all;">https://t.mercor.com/srNUC</a>
        </div>
    </div>
    ...
    <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; border-radius: 8px; padding: 20px; text-align: center; margin-top: 32px;">
        ...
        <ul style="list-style: none; padding: 0; margin: 0; line-height: 2;">
            <li>💰 时薪：$50.5/小时（高于阿拉伯语版本）</li>
            <li>🌍 完全远程，灵活时间</li>
            <li>🔥 本月已招聘29人，机会真实可靠</li>
            <li>🤖 参与前沿AI安全红队测试</li>
            <li>🎁 推荐奖励高达 $210/人</li>
            <li>🗣️ 英语+中文双语优势</li>
        </ul>
...
tool, created = Tool.objects.update_or_create(
    slug='ai-redteamer-chinese-mercor',
    defaults={
        'name': 'AI Red-Teamer — Adversarial AI Testing (Advanced); English & Chinese',
        'short_description': '远程AI红队测试专家，$50.5/小时，英语+中文，对抗性AI测试和漏洞发现',
        'full_description': full_content,
        'website_url': 'https://t.mercor.com/srNUC',
        'category': category,
        'is_featured': True,
        'is_published': True,
    }
...
print('✓ 已添加：AI Red-Teamer — Adversarial AI Testing (Advanced); English & Chinese' if created else '✓ 已更新：AI Red-Teamer — Adversarial AI Testing (Advanced); English & Chinese')
