...
<div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'PingFang SC', sans-serif; line-height: 1.8; color: #333;">
    ...
    <div style="background: #fff; border: 1px solid #e0e0e0; border-radius: 8px; padding: 20px; margin-bottom: 24px;">
        <p style="color: #555; line-height: 1.8; margin-bottom: 12px;">Mercor与领先的AI研究实验室合作，支持先进机器学习系统的评估。我们正在寻找经验丰富的机器学习工程师和研究人员，为衡量AI在真实世界机器学习工程任务上的性能设计高质量评估套件。</p>
        <p style="color: #555; line-height: 1.8;">该工作专注于将实际的ML研究和工程工作流程转化为前沿模型的结构化基准。这是一个基于项目的远程机会，适合具有实际ML研究经验的专家。</p>
    </div>
    ...
    <div style="background: #f8f9fa; border-radius: 8px; padding: 20px; margin-bottom: 24px;">
        <ul style="line-height: 2; margin: 0; padding-left: 24px; color: #555;">
            <li>为机器学习工程任务设计和编写详细的评估套件</li>
            <li>评估AI生成的解决方案，涵盖模型训练、调试、优化和实验等领域</li>
        </ul>
    </div>
    ...
    <div style="background: #fff; border: 1px solid #e0e0e0; border-radius: 8px; padding: 20px; margin-bottom: 24px;">
        <ul style="line-height: 2; margin: 0; padding-left: 24px; color: #555;">
            <li><strong>3年+</strong>机器学习工程或应用ML研究经验</li>
            <li>具有模型开发、实验和评估的实际经验</li>
            <li>具有ML研究背景（强烈推荐工业实验室或学术环境）</li>
            <li>对ML系统设计选择和权衡有很强的推理能力</li>
            <li>清晰的书面沟通能力和高度的技术细节关注</li>
        </ul>
    </div>
...
tool, created = Tool.objects.update_or_create(
    slug='machine-learning-engineer-mercor-v2',
    defaults={
        'name': 'Machine Learning Engineer - Mercor',
        'short_description': '远程机器学习工程师，$100-$120/小时，设计ML评估套件，需3年+经验',
