...
<div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'PingFang SC', sans-serif; line-height: 1.8; color: #333;">
    <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 24px; margin-bottom: 24px; border-radius: 8px;">
        <h2 style="color: white; margin-bottom: 12px; font-size: 24px;">💼 AI Red-Teamer — Adversarial AI Testing (Advanced); English & Hindi</h2>
        <div style="display: flex; gap: 16px; flex-wrap: wrap; margin-top: 16px;">
            ...
            <span style="background: rgba(255,255,255,0.2); padding: 6px 12px; border-radius: 4px;">💰 $13.87/hour</span>
        </div>
    </div>

    <div style="background: #e3f2fd; border-left: 4px solid #2196f3; padding: 16px; margin-bottom: 24px; border-radius: 4px;">
        <p style="margin: 0; color: #1565c0; font-size: 16px;"><strong>🔥 本月已招聘36人</strong></p>
    </div>
    ...
    <div style="background: #fff3e0; border-left: 4px solid #ff9800; padding: 16px; margin-bottom: 24px; border-radius: 4px;">
        ...
        <p style="margin: 0 0 8px 0; color: #666;">🌍 地区限制：印度</p>
        <p style="margin: 0; color: #666;">🗣️ 语言要求：英语和印地语母语级流利度</p>
    </div>
    ...
    <div style="background: #e8f5e9; border-radius: 8px; padding: 20px; margin-bottom: 24px;">
        <p style="color: #2e7d32; line-height: 1.8; margin-bottom: 12px;"><strong>通过推荐赚取高达 $60</strong></p>
        <p style="color: #555; line-height: 1.8; margin-bottom: 12px;">分享下面的推荐链接，每成功推荐一人即可赚取高达 $60。您可以推荐的人数没有限制。可能适用限制条件。</p>
        <div style="background: white; border-radius: 6px; padding: 12px; margin-top: 12px;">
            <a href="https://t.mercor.com/Grz3a" target="_blank" style="color: #667eea; text-decoration: none; word-break: break-all;">https://t.mercor.com/Grz3a</a>
        </div>
    </div>
...
tool, created = Tool.objects.update_or_create(
    slug='ai-redteamer-hindi-mercor',
    defaults={
        'name': 'AI Red-Teamer — Adversarial AI Testing (Advanced); English & Hindi',
        'short_description': '远程AI红队测试专家，$13.87/小时，英语+印地语，对抗性AI测试和漏洞发现',
        'full_description': full_content,
        'website_url': 'https://t.mercor.com/Grz3a',
        'category': category,
        'is_featured': True,
        'is_published': True,
    }
...
print('✓ 已添加：AI Red-Teamer — Adversarial AI Testing (Advanced); English & Hindi' if created else '✓ 已更新：AI Red-Teamer — Adversarial AI Testing (Advanced); English & Hindi')
